  ...
  config = lib.mkIf cfg.enable {
    ...
    programs = {
      ...
      zsh = {
        ...
        initExtra = ''
            # temporary fix for zsh abbr
            if [[ -f "$HOME/.zsh/plugins/zsh-abbr/share/zsh/zsh-abbr/zsh-abbr.plugin.zsh" ]]; then
              source "$HOME/.zsh/plugins/zsh-abbr/share/zsh/zsh-abbr/zsh-abbr.plugin.zsh"
            fi
